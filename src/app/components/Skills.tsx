...
const skillCategories = [
  {
    ...
    skills: [
      ...
      // { name: 'Vue.js', icon: Code2, level: 'Intermediate' as const },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'GraphQL', icon: Zap, level: 'Intermediate' as const },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'Docker', icon: Box, level: 'Intermediate' as const },
      { name: 'AWS', icon: Cloud, level: 'Intermediate' as const },
      { name: 'CI/CD', icon: Wrench, level: 'Intermediate' as const },
      { name: 'Linux', icon: Terminal, level: 'Intermediate' as const },
